...
namespace JourneyRecipes.Particle
{
    public class PrettySparkleParticle : ABasicParticle
    {
        ...
        public override void Update(ref ParticleRendererSettings settings)
        {
            ...
            _timeSinceSpawn += 1f;
            Opacity = JRUtils.GetLerpValue(0f, FadeInNormalizedTime, _timeSinceSpawn / TimeToLive, clamped: true) * JRUtils.GetLerpValue(1f, FadeOutNormalizedTime, _timeSinceSpawn / TimeToLive, clamped: true);
        ...
        public override void Draw(ref ParticleRendererSettings settings, SpriteBatch spritebatch)
        {
            ...
            color.A /= 2;
            Texture2D value = ModContent.GetTexture("Resprite/Extra_98");
            ...
            float num = JRUtils.GetLerpValue(0f, FadeInEnd, t, clamped: true) * JRUtils.GetLerpValue(FadeOutEnd, FadeOutStart, t, clamped: true);
